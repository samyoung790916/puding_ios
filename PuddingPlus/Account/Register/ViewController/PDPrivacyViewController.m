...
#import "PDPrivacyViewController.h"
#import <WebKit/WebKit.h>

@interface PDPrivacyViewController ()<WKNavigationDelegate,UIWebViewDelegate>
/** wkWebView网页 */
...
@implementation PDPrivacyViewController
...
#pragma mark - 初始化导航栏
- (void)initalNav{
    self.title = NSLocalizedString( @"privacy_clause", nil);
