...
static const CGFloat kVideoControlBarHeight = 45.0;
static const CGFloat kVideoControlAnimationTimeInterval = 0.3;
static const CGFloat kVideoControlTimeLabelFontSize = 10.0;
static const CGFloat kVideoControlBarAutoFadeOutTimeInterval = 5.0;

@interface PDVideoPlayerControlView ()
...
@implementation PDVideoPlayerControlView
...
//    self.closeButton.frame = CGRectMake(CGRectGetWidth(self.topBar.bounds) - CGRectGetWidth(self.closeButton.bounds), CGRectGetMinX(self.topBar.bounds), CGRectGetWidth(self.closeButton.bounds), CGRectGetHeight(self.closeButton.bounds));
    ...
    self.playButton.frame = CGRectMake(CGRectGetMinX(self.bottomBar.bounds), 0, CGRectGetWidth(self.playButton.bounds), CGRectGetHeight(self.playButton.bounds));
...
- (UIButton *)fullScreenButton
{
    if (!_fullScreenButton) {
        ...
        [_fullScreenButton setImage:[UIImage imageNamed:@"video-player-full_screen"] forState:UIControlStateNormal];
...
- (UIButton *)shrinkScreenButton
{
    if (!_shrinkScreenButton) {
        ...
        [_shrinkScreenButton setImage:[UIImage imageNamed:@"video-player-small_screen"] forState:UIControlStateNormal];
